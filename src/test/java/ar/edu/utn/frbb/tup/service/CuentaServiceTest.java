 ...
 * 
 * when(clienteDao.findByDni(cuenta.getDniTitular())).thenReturn(
 * clienteExistente);
 * 
 ...
 * verify(transferenciaDao,
 * times(1)).borrarTransferencia(cuenta.getDniTitular());
 * 
 ...
 * CuentaService.borrarCuenta(cuenta.getCBU()));
 * 
 * verify(movimientoDao, times(0)).borrarMovimiento(cuenta.getDniTitular());
 * verify(transferenciaDao,
 * times(0)).borrarTransferencia(cuenta.getDniTitular());
 * 
 * verify(cuentaDao, times(1)).borrarCuenta(cuenta.getCBU());
 * }
 * 
 * @Test
 * public void testMostrarCuentaSuccess() throws CuentaNoEncontradaException,
 ...
 * );
 * 
 * List<Cuenta> cuentasMostradas =
 * CuentaService.mostrarCuenta(cliente.getDni());
 * 
 ...
 * throws CuentaNoEncontradaException, ClienteNoEncontradoException {
 * ClienteDto clienteDto = getClienteDto();
 * Cliente cliente = new Cliente(clienteDto);
 * 
 ...
 * 
 * @Test
 * public void testMostrarCuentaCuentaNoEncontrada() throws
 ...
 * 
 * @Test
 * public void testObtenerTodasLasCuentasSuccess() throws
 ...
 * 
 * @Test
 * public void testObtenerTodasLasCuentasFail() throws
 * CuentaNoEncontradaException {
 * List<Cuenta> cuentas = List.of();
 * 
 * when(cuentaDao.mostrarTodasLasCuentas()).thenReturn(cuentas);
 * 
 * assertThrows(CuentaNoEncontradaException.class, () ->
 * CuentaService.obtenerTodasLasCuentas());
 * 
 * verify(cuentaDao, times(1)).mostrarTodasLasCuentas();
 * }
 * 
