 ...
 * 
 * ResponseEntity<Movimiento> response =
 * movimientoController.realizarDeposito(cbu, monto);
 * 
 ...
 * double monto = 100;
 * 
 * doThrow(CuentaNoEncontradaException.class).when(movimientoService).
 * realizarDeposito(cbu, monto);
 * 
 ...
 * 
 * @Test
 * public void testRealizarRetiro() throws CuentaNoEncontradaException,
 ...
 * 
 * ResponseEntity<Movimiento> response =
 * movimientoController.realizarRetiro(cbu, monto);
 * 
 ...
 * 
 * @Test
 * public void testRealizarRetiroError() throws CuentaNoEncontradaException,
 * CuentaSinSaldoException {
 * 
 * long cbu = 12345678;
 * double monto = 100;
 ...
 * 
 * when(movimientoService.obtenerOperacionesPorCBU(12345678)).thenReturn(
 * movimientos);
 * 
 * ResponseEntity<List<Movimiento>> operaciones =
 * movimientoController.obtenerOperacionesPorCBU(12345678);
 * 
 ...
 * MomivientosVaciosException {
 * 
 * doThrow(MomivientosVaciosException.class).when(movimientoService).
 * obtenerOperacionesPorCBU(anyLong());
 * 
 * assertThrows(MomivientosVaciosException.class, () ->
 * movimientoController.obtenerOperacionesPorCBU(anyLong()));
 * 
