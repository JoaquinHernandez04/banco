 ...
 * 
 * @Test
 * public void testCrearCuentaSuccess() throws CuentaNoEncontradaException,
 ...
 * CuentaDto cuentaDto = getCuentaDto();
 * 
 * doThrow(ClienteNoEncontradoException.class).when(cuentaService).
 ...
 * cuentaController.eliminarCuentaPorCBU(anyLong());
 * 
 ...
 * 
 * doThrow(CuentaNoEncontradaException.class).when(cuentaService).borrarCuenta(
 * anyLong());
 * 
 ...
 * 
 * @Test
 * public void testMostrarTodasCuentasSuccess() throws
 ...
 * 
 * ResponseEntity<List<Cuenta>> response =
 * cuentaController.mostrarTodasLasCuentas();
 * 
 ...
 * {
 * 
 * doThrow(CuentaNoEncontradaException.class).when(cuentaService).
 ...
 * 
 * @Test
 * public void testMostrarCuentaPorDniSuccess() throws
 * CuentaNoEncontradaException, ClienteNoEncontradoException {
 * 
 * List<Cuenta> cuentas = new ArrayList<>();
 * 
 ...
 * 
 * ResponseEntity<List<Cuenta>> response =
 * cuentaController.mostrarCuentasPorDni(anyLong());
 * 
 ...
 * 
 * @Test
 * public void testMostrarCuentaPorDniFail() throws CuentaNoEncontradaException,
 * ClienteNoEncontradoException {
 * 
 * doThrow(CuentaNoEncontradaException.class).when(cuentaService).mostrarCuenta(
 * anyLong());
 * 
 * assertThrows(CuentaNoEncontradaException.class, () ->
 * cuentaController.mostrarCuentasPorDni(anyLong()));
