 ...
 * 
 * @Test
 * public void testDarDeAltaClienteExistente() throws
 ...
 * when(clienteDao.findByDni(cliente.getDni())).thenReturn(null);
 * 
 * assertThrows(ClienteMenorEdadException.class, () ->
 * ClienteService.darDeAltaCliente(clienteDto));
 * 
 * verify(clienteDao, times(1)).findByDni(cliente.getDni());
 * verify(clienteDao, times(0)).crearCliente(any(Cliente.class));
 ...
 * 
 * @Test
 * public void testBorrarClienteNoEncontrado() throws
 ...
 * ClienteService.borrarCliente(cliente.getDni()));
 * 
 ...
 * 
 * @Test
 * public void testMostrarClienteNoEncontrado() throws
 * ClienteNoEncontradoException {
 * ClienteDto clienteDto = getClienteDto();
 * Cliente cliente = new Cliente(clienteDto);
 * 
 ...
 * 
 * assertThrows(ClienteNoEncontradoException.class, () ->
 * ClienteService.mostrarCliente(cliente.getDni()));
 * 
 * verify(clienteDao, times(1)).mostrarCliente(cliente.getDni());
 * }
 * 
 ...
 * 
 * @Test
 * public void testMostrarTodosLosClientesNoEncontrado() throws
 * ClienteNoEncontradoException {
