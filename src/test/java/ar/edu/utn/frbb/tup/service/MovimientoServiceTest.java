 ...
 * 
 * Movimiento movimiento = movimientoService.realizarDeposito(cuenta.getCBU(),
 * 10);
 * 
 ...
 * movimientoService.realizarDeposito(cuenta.getCBU(), 10));
 * 
 * verify(cuentaDao, times(1)).obtenerCuentaPorCBU(cuenta.getCBU());
 ...
 * 
 * @Test
 * public void testRealizarRetiroSuccess() throws CuentaNoEncontradaException,
 * CuentaSinSaldoException{
 * CuentaDto cuentaDto = getCuentaDto();
 * Cuenta cuenta = new Cuenta(cuentaDto);
 * 
 ...
 * when(cuentaDao.obtenerCuentaPorCBU(cuenta.getCBU())).thenReturn(cuenta);
 * 
 * Movimiento movimiento = movimientoService.realizarRetiro(cuenta.getCBU(),
 * 10);
 * 
 * verify(cuentaDao, times(1)).obtenerCuentaPorCBU(cuenta.getCBU());
 ...
 * 
 * @Test
 * public void testRealizarRetiroCuantaNoEncontrada() throws
 * CuentaNoEncontradaException, CuentaSinSaldoException{
 * CuentaDto cuentaDto = getCuentaDto();
 * Cuenta cuenta = new Cuenta(cuentaDto);
 * 
 * when(cuentaDao.obtenerCuentaPorCBU(cuenta.getCBU())).thenReturn(null);
 * 
 * assertThrows(CuentaNoEncontradaException.class, () ->
 * movimientoService.realizarRetiro(cuenta.getCBU(), 10));
 * 
 * verify(cuentaDao, times(1)).obtenerCuentaPorCBU(cuenta.getCBU());
 * verify(cuentaDao,times(0)).actualizarBalanceCuenta(cuenta.getCBU(), 10);
 * verify(movimientosDao, times(0)).guardarMovimiento(any(Movimiento.class));
 ...
 * 
 * @Test
 * public void testRealizarRetiroCuentaSinSaldo() throws
 * CuentaNoEncontradaException, CuentaSinSaldoException{
 * CuentaDto cuentaDto = getCuentaDto();
 * Cuenta cuenta = new Cuenta(cuentaDto);
 * 
 ...
 * when(cuentaDao.obtenerCuentaPorCBU(cuenta.getCBU())).thenReturn(cuenta);
 * 
 * assertThrows(CuentaSinSaldoException.class, () ->
 * movimientoService.realizarRetiro(cuenta.getCBU(), 110));
 * 
 * verify(cuentaDao, times(1)).obtenerCuentaPorCBU(cuenta.getCBU());
 * verify(cuentaDao,times(0)).actualizarBalanceCuenta(cuenta.getCBU(), 10);
 * verify(movimientosDao, times(0)).guardarMovimiento(any(Movimiento.class));
 ...
 * 
 * @Test
 * public void testObtenerOperacionesPorCBU() throws
 * CuentaNoEncontradaException, MomivientosVaciosException {
 * Movimiento movimiento = getMovimiento();
 * List<Movimiento> operaciones = new ArrayList<>();
 * 
 * operaciones.add(movimiento);
 * 
 * when(movimientosDao.obtenerOperacionesPorCBU(any(Long.class))).thenReturn(
 * operaciones);
 * 
 * List<Movimiento> operacionesObtenidas =
 * movimientoService.obtenerOperacionesPorCBU(any(Long.class));
 * 
 ...
 * 
 * @Test
 * public void testObtenerOperacionesPorCBUEmpty() throws
 * CuentaNoEncontradaException, MomivientosVaciosException {
 * List<Movimiento> operaciones = new ArrayList<>();
 * 
 * when(movimientosDao.obtenerOperacionesPorCBU(any(Long.class))).thenReturn(
 * operaciones);
 * 
 * assertThrows(MomivientosVaciosException.class, () ->
 * movimientoService.obtenerOperacionesPorCBU(any(Long.class)));
 * 
 * verify(movimientosDao, times(1)).obtenerOperacionesPorCBU(any(Long.class));
 * 
