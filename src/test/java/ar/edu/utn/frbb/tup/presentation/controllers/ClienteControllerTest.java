...
public class ClienteControllerTest {
    ...
    public void testMostrarTodosLosClientesError() throws ClienteNoEncontradoException {
        ...
        doThrow(new ClienteNoEncontradoException("No se encontraron clientes")).when(clienteService)
    ...
    public void testMostrarClienteError() throws ClienteNoEncontradoException {
        ...
        doThrow(new ClienteNoEncontradoException("No se encontro el cliente")).when(clienteService)
