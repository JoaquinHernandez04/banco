 ...
 * 
 * @Test
 * public void testMostrarTodosLosClientesSuccess() throws
 * ClienteNoEncontradoException {
 * List<Cliente> clientes = new ArrayList<>();
 * 
 * when(clienteService.mostrarTodosLosClientes()).thenReturn(clientes);
 * 
 * ResponseEntity<List<Cliente>> mostrados =
 * clienteController.getTodosLosClientes();
 * 
 ...
 * 
 * @Test
 * public void testMostrarTodosLosClientesError() throws
 * ClienteNoEncontradoException {
 * 
 * doThrow(new ClienteNoEncontradoException("No se encontraron clientes")).when(
 * clienteService)
 ...
 * 
 * ResponseEntity<Cliente> clientemostrado =
 * clienteController.mostrarCliente(cliente.getDni());
 * 
 ...
 * 
 * doThrow(new ClienteNoEncontradoException("No se encontro el cliente")).when(
 * clienteService)
 * .mostrarCliente(anyLong());
 * 
 * assertThrows(ClienteNoEncontradoException.class, () ->
 * clienteController.mostrarCliente(12345678));
 * 
 ...
 * 
 * ResponseEntity<Cliente> modificado =
 * clienteController.modificarCliente(12345678, clienteDto);
 * 
 ...
 * doThrow(new ClienteNoEncontradoException("No se encontro el cliente")).when(
 * clienteService)
 * .borrarCliente(anyLong());
 * 
 * assertThrows(ClienteNoEncontradoException.class, () ->
 * clienteController.borrarCliente(12345678));
 * 
 * verify(clienteService, times(1)).borrarCliente(anyLong());
 * }
 * 
 * @Test
 * public void testDarDeAltaClienteSuccess() throws
 * ClienteAlreadyExistsException, ClienteMenorEdadException {
 * 
 * ClienteDto clienteDto = getClienteDto();
 * 
 * when(clienteService.darDeAltaCliente(clienteDto)).thenReturn(new Cliente());
 * 
 * ResponseEntity<Cliente> alta =
 * clienteController.darDeAltaCliente(clienteDto);
 * 
 ...
 * 
 * @Test
 * public void testDarDeAltaClienteFail() throws ClienteAlreadyExistsException,
 * ClienteMenorEdadException {
 * 
 * ClienteDto clienteDto = getClienteDto();
 * 
 * doThrow(new
 * ClienteAlreadyExistsException("El cliente ya existe")).when(clienteService)
